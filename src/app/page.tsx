...
import { ArrowRight, ArrowLeft, Send, Loader2, ExternalLink } from "lucide-react";
...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Hero: H1 + H2 + intro paragraph — visible above the fold on step 1 */}
      {currentStep === 1 && (
        <section className="w-full px-4 md:px-6 pt-6 pb-2 md:pt-10 md:pb-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-3">
              App Development Cost Calculator
            </h1>
            <h2 className="text-base md:text-xl text-gray-600 font-medium mb-4 md:mb-5">
            ...
            <p className="text-sm md:text-base text-gray-600 leading-relaxed max-w-3xl mx-auto">
              ...
              an agency, or a dedicated development company like Tecaudex. Use the calculator below to
      ...
      {/* FAQ */}
      <section className="w-full px-4 md:px-6 py-10 md:py-16 bg-white">
